...
path = '/research/CU_study/'

net, chan1, chan2 = "CU", "BH2", "BH2"
...
stime = UTCDateTime('2006-001T00:00:00')
etime = UTCDateTime('2023-01-01T00:00:00')

if test_run:
    client = Client()
    inv = client.get_stations(starttime=stime, endtime=etime, station="238A",
...
def run_station(net_sta):
    ...
    stime = UTCDateTime('2006-001T00:00:00')
    etime = UTCDateTime('2023-01-01T00:00:00')
    if etime >= UTCDateTime('2023-001T00:00:00'):
        etime = UTCDateTime('2023-01-01T00:00:00')
    #if test_run:
